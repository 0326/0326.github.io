...
<div class="main animated  lightSpeedIn">
	...
	<div class="nav-box" id="about">
		<a  class="none-href" href="about.md">
		<div class="nav-content">
			<h2 class="nav-title">关于本站</h2>
		</div>
		</a>
	</div>	
	<div class="nav-box" id="project">
		<a  class="none-href" href="/project/index.md">
		<div class="nav-content">
			<h2 class="nav-title">作品&项目</h2>
		</div>
		</a>
	</div>
	<div class="nav-box" id="link">
		<a  class="none-href" href="link.md">
		<div class="nav-content">
		<h2 class="nav-title">前端链接</h2>
		</div>
		</a>
	</div>
	<div class="nav-box" id="blog">
		<a  class="none-href" href="blog.md">
		<div class="nav-content">
